...
import { FlipHorizontal, Search, X } from 'lucide-react';
...
const VennDiagramNetwork = () => {
  ...
  // Calculate overlaps between themes
  ...
  // Find significant overlaps (>15% average overlap)
  const overlaps = [];
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <p style={{
            ...
            Click any bubble to see example searches • Hover over overlaps to see shared terms
          </p>
          <div style={{
            display: 'inline-flex',
            alignItems: 'center',
        ...
        <div style={{ position: 'relative', marginBottom: '30px' }}>
          ...
          >
            {/* Draw connection lines for overlaps */}
            ...
            {themes.map((theme) => {
              ...
              return (
                ...
                >
                  ...
                  {!isFlipped ? (
                    // Front side - Theme name and stats
                    <>
                      <text
                        x={theme.x}
                        y={theme.y - 15}
          ...
          {selectedOverlap && (
            <div style={{
              ...
              <div style={{
                ...
                {selectedOverlap.theme1.name} ↔ {selectedOverlap.theme2.name}
              </div>
              <div style={{
                fontSize: '0.9em',
                color: colors.gray,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <strong style={{ color: colors.primary }}>• Bubble Size:</strong> Represents search volume (larger = more searches)
            </div>
            <div>
              <strong style={{ color: colors.primary }}>• Overlapping Position:</strong> Bubbles placed near each other share search terms
            </div>
            <div>
              <strong style={{ color: colors.primary }}>• Click Bubbles:</strong> Flip to see example search queries
            </div>
            <div>
              <strong style={{ color: colors.primary }}>• Hover Numbers:</strong> Shows how many terms are shared between themes
            </div>
            <div>
              <strong style={{ color: colors.primary }}>• Key Terms:</strong> certification, course, certificate, training, program
            </div>
          </div>
        </div>
...
export default VennDiagramNetwork;